...
func GetMap() *SensitiveMap {
	if s == nil {
		...
		dictionaryPath := "E:/Workspace/GWork/project/src/data/dict/sensitiveWords.txt"
...
//InitDictionary 初始化敏感词词典，根据DFA算法构建trie
...
//CheckSensitive 作用：检查是否含有敏感词，仅返回检查到的第一个敏感词
//返回值：敏感词，是否含有敏感词
